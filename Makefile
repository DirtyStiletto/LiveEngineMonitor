...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = LEMbeta11.0.0
DISTDIR = /workspaces/delete03/.tmp/LEMbeta11.0.0
...
SOURCES       = LEMmain.cpp \
		functionCollector.cpp qrc_qml.cpp \
		moc_functionCollector.cpp
OBJECTS       = LEMmain.o \
		functionCollector.o \
		qrc_qml.o \
		moc_functionCollector.o
DIST          = /usr/lib/arm-linux-gnueabihf/qt5/mkspecs/features/spec_pre.prf \
		...
		LEMmain.pro LEMmain.h \
		functionCollector.h LEMmain.cpp \
		functionCollector.cpp
QMAKE_TARGET  = LEMbeta1
DESTDIR       = appconfig_0/work/LiveEngineMonitor/
TARGET        = appconfig_0/work/LiveEngineMonitor/LEMbeta1


first: all
####### Build rules

appconfig_0/work/LiveEngineMonitor/LEMbeta1:  $(OBJECTS)  
	@test -d appconfig_0/work/LiveEngineMonitor/ || mkdir -p appconfig_0/work/LiveEngineMonitor/
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: LEMmain.pro /usr/lib/arm-linux-gnueabihf/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/arm-linux-gnueabihf/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/common/unix.conf \
		/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/common/linux.conf \
		/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/common/sanitize.conf \
		/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/common/gcc-base.conf \
		...
		LEMmain.pro \
		qml.qrc
	$(QMAKE) -o Makefile LEMmain.pro -qtconf /usr/lib/arm-linux-gnueabihf/qt5/qt.conf -early QMAKE_CC=arm-linux-gnueabihf-gcc QMAKE_CXX=arm-linux-gnueabihf-g++ QMAKE_LINK=arm-linux-gnueabihf-g++ QMAKE_STRIP=arm-linux-gnueabihf-strip QMAKE_QMAKE=/usr/bin/arm-linux-gnueabihf-qmake PKG_CONFIG=arm-linux-gnueabihf-pkg-config -before CONFIG+=debug
...
all: Makefile appconfig_0/work/LiveEngineMonitor/LEMbeta1
...
distdir: FORCE
	...
	$(COPY_FILE) --parents LEMmain.h functionCollector.h $(DISTDIR)/
	$(COPY_FILE) --parents LEMmain.cpp functionCollector.cpp $(DISTDIR)/
...
compiler_moc_header_make_all: moc_functionCollector.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_functionCollector.cpp
moc_functionCollector.cpp: functionCollector.h \
		moc_predefs.h \
		/usr/lib/qt5/bin/moc
	/usr/lib/qt5/bin/moc $(DEFINES) --include /workspaces/delete03/moc_predefs.h -I/usr/lib/arm-linux-gnueabihf/qt5/mkspecs/linux-g++ -I/workspaces/delete03 -I/usr/include/arm-linux-gnueabihf/qt5 -I/usr/include/arm-linux-gnueabihf/qt5/QtQuick -I/usr/include/arm-linux-gnueabihf/qt5/QtGui -I/usr/include/arm-linux-gnueabihf/qt5/QtQmlModels -I/usr/include/arm-linux-gnueabihf/qt5/QtQml -I/usr/include/arm-linux-gnueabihf/qt5/QtNetwork -I/usr/include/arm-linux-gnueabihf/qt5/QtCore -I/usr/arm-linux-gnueabihf/include/c++/10 -I/usr/arm-linux-gnueabihf/include/c++/10/arm-linux-gnueabihf -I/usr/arm-linux-gnueabihf/include/c++/10/backward -I/usr/lib/gcc-cross/arm-linux-gnueabihf/10/include -I/usr/arm-linux-gnueabihf/include -I/usr/include/arm-linux-gnueabihf -I/usr/include functionCollector.h -o moc_functionCollector.cpp
...
LEMmain.o: LEMmain.cpp functionCollector.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o LEMmain.o LEMmain.cpp

functionCollector.o: functionCollector.cpp functionCollector.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o functionCollector.o functionCollector.cpp

qrc_qml.o: qrc_qml.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o qrc_qml.o qrc_qml.cpp

moc_functionCollector.o: moc_functionCollector.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_functionCollector.o moc_functionCollector.cpp
